    ...
    <div className="flex flex-col gap-6 animate-fadeIn w-full pb-10">
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-[#EAECF0]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Secondary Tool Execution Report — blurred out as requested */}
          <div className="border border-[#EAECF0] rounded-2xl p-6 bg-white transition-all flex flex-col justify-between opacity-50 pointer-events-none grayscale">
            <div>
              <div className="flex justify-between items-start mb-6">
